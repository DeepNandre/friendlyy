...
const solutions = [
  {
    ...
    desc: "No time to wait on hold? Friendly calls for quotes, books appointments, and handles tedious admin.",
  ...
  },
  {
    ...
    desc: "Get quotes from multiple suppliers, book services, cancel unused subscriptions—all while you focus on your business.",
  ...
  {
    label: "Parents",
    desc: "Friendly books doctor appointments, finds childcare availability, and calls schools—so you don't have to.",
  ...
  {
    label: "Phone-anxious",
    desc: "Hate making phone calls? Same. Friendly does it for you with zero awkwardness.",
  ...
  {
    label: "Anyone who values time",
    desc: "Stop spending 30 minutes on hold. Friendly waits for you and calls you back when a human answers.",
  ...
  return (
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-6">
        <p className="font-sans text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4">Who Uses Friendly</p>
        <h2 className="font-serif text-4xl md:text-5xl font-normal text-foreground mb-12 leading-tight max-w-2xl">
          Built for people who hate phone calls
        </h2>
        <p className="font-sans text-base text-muted-foreground mb-12 max-w-xl -mt-8">
          Friendly handles the calls you've been putting off. Just type what you need.
        </p>
